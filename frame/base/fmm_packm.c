...
//     bli_obj_alias_to( &a_local, &at_local );
//     if ( bli_obj_has_trans( &a_local ) )
//     {
//         bli_obj_set_onlytrans( BLIS_NO_TRANSPOSE, &at_local );
//     }
//     else
//     {
...
//     obj_t* at_pack = malloc(fmm->R * sizeof(obj_t));

//     siz_t size_p = bli_packm_init( &at_local, at_pack, cntl ) * fmm->R; 

//     for (int r = 1; r < fmm->R; r++) {
//         bli_packm_init(&at_local, &at_pack[r], cntl);
//     }   
...
//         bli_obj_set_buffer( offset_buffer, &at_pack[r] );
...
//         {
//             ((float*)paramsB.coef)[paramsB.nsplit] = __U(isplits, r);
...
//         bli_obj_induce_trans( &at_pack[r] );
...
//         {
//             ((float*)paramsA.coef)[paramsA.nsplit] = __V(isplits, r);
